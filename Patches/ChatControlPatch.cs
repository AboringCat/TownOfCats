...
class ChatControllerUpdatePatch
{
    ...
    public static void Postfix(ChatController __instance)
    {
        if (Main.DarkTheme.Value)
        {
            ...
            else QuickChatIcon.sprite = Utils.LoadSprite("TOC.Resources.Images.DarkQuickChat.png", 100f);

            if (OpenBanMenuIcon == null) OpenBanMenuIcon = GameObject.Find("OpenBanMenuIcon")?.transform.GetComponent<SpriteRenderer>();
            else OpenBanMenuIcon.sprite = Utils.LoadSprite("TOC.Resources.Images.DarkReport.png", 100f);

            if (OpenKeyboardIcon == null) OpenKeyboardIcon = GameObject.Find("OpenKeyboardIcon")?.transform.GetComponent<SpriteRenderer>();
            else OpenKeyboardIcon.sprite = Utils.LoadSprite("TOC.Resources.Images.DarkKeyboard.png", 100f);
        }
        else
        {
