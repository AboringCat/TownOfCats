        ...
        public static void Postfix_Initialize(GameOptionsMapPicker __instance)
        {
            ...
            if (AllMapButton != null)
            {
                ...
                dlekS_ehT_MapButton.Button.OnClick.AddListener((Action)(() =>
                {
                    ...
                    __instance.MapImage.sprite = Utils.LoadSprite("TOC.Resources.Images.DleksBanner.png", 100f);
                    __instance.MapName.sprite = Utils.LoadSprite("TOC.Resources.Images.DleksBanner-Wordart.png", 100f);
                }));
